...
------------ | ------------- | ------------- | -------------
**Secrets** | Pointer to [**[]SecretMetadataResponse**](SecretMetadataResponse.md) |  | [optional] 
...
`func (o *SecretListResponse) GetSecrets() []SecretMetadataResponse`

GetSecrets returns the Secrets field if non-nil, zero value otherwise.

### GetSecretsOk

`func (o *SecretListResponse) GetSecretsOk() (*[]SecretMetadataResponse, bool)`
...
`func (o *SecretListResponse) SetSecrets(v []SecretMetadataResponse)`
