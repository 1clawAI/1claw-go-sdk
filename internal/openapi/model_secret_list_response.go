...
type SecretListResponse struct {
	Secrets []SecretMetadataResponse `json:"secrets,omitempty"`
}
...
func (o *SecretListResponse) GetSecrets() []SecretMetadataResponse {
	if o == nil || IsNil(o.Secrets) {
		var ret []SecretMetadataResponse
		return ret
	}
	return o.Secrets
}
...
// SetSecrets gets a reference to the given []SecretMetadataResponse and assigns it to the Secrets field.
